...
<form name="write" method="post" action="pds_write" enctype="multipart/form-data">
	  <table border="0" >
		<tr>
       ...
       <tr>
		...
		<tr></tr>			<tr></tr>
          ...
          <td align=center>
			<img onclick="send()" src="Pds/img/purple_save.gif" width="56" height="18" border="0">
			<img onclick="reset()" src="Pds/img/purple_cancle.gif" width="56" height="18" border="0">
