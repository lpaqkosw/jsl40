...
<tr>
  <td width="80%" valign="top">&nbsp;<img src="./img/title1.gif" ><br>    
	<form name=form_name method=post action="userModify">
				...
				<tr>
					<td bgcolor="#7AAAD5">            
						...
						<table cellpadding=3 cellspacing=1 border=0 width=100%>
							<tr>
								...
								<TD BGCOLOR=WHITE>
									<input type=text name=name size=16 maxlength=20 value="${vo.name }">성명은 빈칸없이 입력하세요.
								</td>
							</tr>
							<tr>
								...
								<TD BGCOLOR=WHITE>
									<table cellspacing=0 cellpadding=0>
										<tr>
											<td align=absmiddle>
												<input type=text name=userid size=12 maxlength=16 value="${vo.userid }" style="width:120">
											</td>
											<td>
                 ...
                 6~12자 이내의 영문이나 숫자만 가능합니다.
							...
							<tr>
								...
								<TD BGCOLOR=WHITE>
									<input type=radio name=gubun <c:if test="${vo.gubun == '직장' }">checked</c:if>>직장&nbsp;&nbsp;
									<input type=radio name=gubun <c:if test="${vo.gubun == '자택' }">checked</c:if>>자택 
								</td>
							</tr>
							...
							<tr>
								...
								<TD BGCOLOR=WHITE>
									<table cellspacing=0 cellpadding=0>
										<tr>
											<td>
                  				<input type=text name=zip size=6 maxlength=6 value="${vo.zipcode }" readonly>
                  		</td>
                  		<td>
							...
							<tr>
								...
								<TD BGCOLOR=WHITE>
									<input type=text name=addr1 size=50 maxlength=100 value="${vo.addr1 }" readonly>
								</td>
							</tr>
							<tr>
                ...
                <TD BGCOLOR="#EFF4F8">&nbsp;관심분야
                	<font color=red>&nbsp;</font>
								...
								<td bgcolor=WHITE valign=middle> 
									...
									<br><input type="checkbox" name="fa" value="여행레져" <c:if test="${vo.favorite.contains('여행레져')}">checked</c:if>>여행레져 &nbsp;&nbsp;
              ...
              <tr>
                ...
                <TD BGCOLOR=WHITE>
                  <select name=job class="formbox">
 										...
 										<option value="종교,언론,에술인" <c:if test="${vo.job == '종교,언론,예술인'}">selected</c:if>>종교.언론/예술인
