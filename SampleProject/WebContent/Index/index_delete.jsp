...
<script>
 ...
 <table width="170px" height="120" border="0">
   ...
   <tr>
     ...
     <table width="50%" height="120" border="20" >
   <form name="login_form" action="userDelete" method="post" >
   <input type="hidden" name="route" value="Index/index.jsp">
     <tr>
     ...
     <tr>
       ...
       <td ><input type="text" size="10" name="userid" value="${userId }" readonly></td>
     </tr>
     <tr>
     ...
     <tr>
       <td></td>
			 <td>
           <input type="button" border="0" onClick="return check_login()" value="회원탈퇴">
       </td>
     </tr>
 </form>
 </table>
