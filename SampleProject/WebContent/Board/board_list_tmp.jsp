	...
	<c:forEach var = "vo" items="${list}">
        ...
        <font face="돋움" size="2" color="#000000">${listcount}</font></td>
			<td align="left" height="20">&nbsp;
				...
				<a class="list" href="javascript:board_view(${vo.idx })">${vo.subject}</a></td>
				...
				<table>
					...
					<!-- 검색어를 이용하여 글제목, 작성자, 글내용 중에 하나를 입력 받아 처리하기 위한 부분 -->
						<tr>
							...
							<td> <a onclick="searchlist()"><img src="Board/img/search2.gif" border="0"></a></td>
						</tr>
					</form>
				</table>
			</td>
			<td width="25%" align="right">
			<a href="javascript:board_write()"><img src="Board/img/write.gif" border="0"></a>
			</td>
		</tr>
	</table>
