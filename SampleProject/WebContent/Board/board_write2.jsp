...
<script>
	...
	function send(){
		if(boardwrite.name.value == ""){
			alert("필수사항을 입력 하세요");
			return
		}
		if(boardwrite.subject.value == ""){
			alert("필수사항을 입력 하세요");
			return
		}
		if(boardwrite.contents.value == ""){
			alert("필수사항을 입력 하세요");
			return
		}
		if(boardwrite.pass.value == ""){
			alert("필수사항을 입력 하세요");
			return
		}
 ...
 <tr>
   <td width="80%" valign="top">&nbsp;<br>
     ...
     <form method="post" name="boardwrite" action="board_write">
