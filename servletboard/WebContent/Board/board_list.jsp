...
<%@ page import ="board.model.*, java.util.List" %>
<%
...
%>
        ...
        <font face="돋움" size="2" color="#000000"><%=list.get(i).getIdx() %></font></td>
			<td align="left" height="20">&nbsp;
				...
				<td align="center" height="20"><font face="돋움" size="2"><%=list.get(i).getRegdate() %></font></td>
				<td align="center" height="20"><font face="돋움" size="2">
...
%>
	...
	<table width="600">
		<tr>
			...
			<a href="Board/board_write.jsp"><img src="Board/img/write.gif" border="0"></a>
			</td>
		</tr>
	</table>
</body>
