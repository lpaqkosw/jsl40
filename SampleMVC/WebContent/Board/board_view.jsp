...
<script>
	function del(){
		window.open("Board?command=board_del&idx="+${vo.idx},"삭제", "width=600px height=400px");
	}
   ...
   <table border="0" width="800">
     <tr>
      ...
      <font size="2">
	   ...
	   <!-- 수정하기 -->
       <a href="/Board?command=board_mod&idx=${vo.idx }">
       <img src="Board/img/edit.gif" border="0"></a>&nbsp;&nbsp;
         <!-- 삭제하기 -->
       <a href="javascript:del()"><img src="Board/img/del.gif" border="0"></a>&nbsp;&nbsp;
       <!-- 목록보기 -->
       <a href="javascript:backtoList()"><img src="Board/img/list-2.gif" border="0"></a>&nbsp;&nbsp;
      </font>
    </td>
  </tr>
  </table>
