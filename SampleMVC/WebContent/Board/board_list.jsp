  ...
  <tr>
    ...
    <table border="0" cellspacing="1" width="100%" align="center">
      ...
      <tr>
		...
		<font size="2" face="고딕">전체 : <b>${totcount }</b>건 - ${currentPage }/ ${totpage } Pages</font></td></tr>
 	   <tr bgcolor="e3e9ff">
	...
	<c:forEach var="list" items="${list }">
        ...
        <font face="돋움" size="2" color="#000000">${listcount}</font></td>
			<td align="left" height="20">&nbsp;
				...
				<a class="list" href="Board?command=board_view&idx=${list.idx }">${list.subject }</a></td>
	...
	<table width="600">
		<tr>
			...
			<td width="50%" align="center">
				<table>
					<form name ="searchForm" method="post" action="Board?command=board_search">	
					<!-- 검색어를 이용하여 글제목, 작성자, 글내용 중에 하나를 입력 받아 처리하기 위한 부분 -->
						<tr>
							...
							<td> <a href="javascript:searchsubmit()"><img src="Board/img/search2.gif" border="0"></a></td>
						</tr>
					</form>
				</table>
			</td>
