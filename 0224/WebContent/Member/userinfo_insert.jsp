...
<script>
	function send(){
		alert("전송");
		insert.action="userinfo_modify.jsp";
		insert.submit();
            ...
            <table cellpadding=0 cellspacing=0 border=0 width=100%>
              ...
              <tr bgcolor=#ffffff>
                <td colspan=3 align=center>
                  <img onclick="send()" src="./img/u_bt06.gif" vspace=3 border=0 name=img3>
                  <img onclick="reset()"src="./img/u_bt05.gif" border=0 hspace=10 vspace=3 name=img4>
                </td>
              </tr>
            </table> 
          </td>
