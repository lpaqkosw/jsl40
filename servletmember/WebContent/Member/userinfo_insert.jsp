...
<tr>
  ...
  <td width="80%" valign="top">&nbsp;<img src="Member/img/title1.gif" ><br>    
	<form name=form_name method=post action="../servletmember/MemInsert">
			...
			<table cellpadding=0 cellspacing=0 border=0 width=650 align=center>       
				<tr>
								...
								<TD BGCOLOR=WHITE>
									<table cellspacing=0 cellpadding=0>
										<tr>
											...
											<td>
                  			<img src="Member/img/u_bt01.gif" hspace=2 border=0 name=img1  align=absmiddle onclick="check()">
                 ...
                 6~12자 이내의 영문이나 숫자만 가능합니다.
                  		...
                  		<td>
      									<img src="Member/img/u_bt07.gif" hspace=2 border=0 name=img2 align=absmiddle onclick="postcheck()">
 											</td>
										</tr>
									</table>
								</td>
            ...
            <table cellpadding=0 cellspacing=0 border=0 width=100%>
              ...
              <tr bgcolor=#ffffff>
                <td colspan=3 align=center>
                  <img src="Member/img/u_bt06.gif" vspace=3 border=0 name=img3 onclick="send()">
