				...
				<tr>
                 ...
                 6~12자 이내의 영문이나 숫자만 가능합니다.
							...
							<tr>
								...
								<TD BGCOLOR=WHITE><input type=password name=repasswd size=8 maxlength=12 value="${repasswd }" style="width:80">비밀번호 확인을 위해서 비밀번호를 한번 더 입력해주세요. </td>
							</tr>
							<tr>
								<TD BGCOLOR="#EFF4F8">&nbsp;주소구분<font color=red>&nbsp;</font></td>
								<TD BGCOLOR=WHITE>
									<input type=radio name=gubun <% if(gubun.equals("직장")){ %> checked <%} %>>직장&nbsp;&nbsp;
									<input type=radio name=gubun <% if(gubun.equals("자택")){ %> checked <%} %>>자택 
								</td>
							</tr>
            ...
            <table cellpadding=0 cellspacing=0 border=0 width=100%>
              ...
              <tr bgcolor=#ffffff>
                <td colspan=3 align=center>
                  <img src="Member/img/u_bt06.gif" vspace=3 border=0 name=img3>
